# AX Serving v2.3.0: Apache-2.0 migration

AX Serving v2.3.0 is licensed under the Apache License, Version 2.0. The
...
The v2.3 server no longer has a commercial-license activation state:
...
build-license metadata. Its v2.3 response has this shape:
...
The Rust workspace, JavaScript SDK, and Python SDK are versioned `2.3.0`.
...
v2.3.0 source and distributions in this release line.
